...
HOOK(int, __fastcall, CTitleMainFinish, 0x5727F0, Sonic::CGameObject* This)
{
	...
	printf("%d", inputPtr->LeftStickHorizontal);
	...
	printf("CTitleMainFinish");
	return 0;
}
HOOK(int, __fastcall, CTitlePressSelectIntro, 0x572750, Sonic::CGameObject* This)
{
	printf("CTitlePressSelectIntro");
	return originalCTitlePressSelectIntro(This);
}
HOOK(int, __fastcall, CTitleInit, 0x11D12A0, int a1)
{
	printf("CTitleInit");
	return originalCTitleInit(a1);
}
...
void HudTitle::Install()
{
	...
	INSTALL_HOOK(CTitlePressSelectIntro);
}
